...
for n_komsuluk in komsuluk_sayisi:
    ...
    snf.fit(X_egitim,y_egitim)
    egitim_dogruluk.append(snf.score(X_egitim,y_egitim)) 	# 0.946
    test_dogruluk.append(snf.score(X_test,y_test))			# 0.937
...
print(reg.score(X_egitim,y_egitim)) # 0.8194343929538755
print(reg.score(X_test,y_test)) # 0.8344172446249605
