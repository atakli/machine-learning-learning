...
# bir kişinin eğitim, yaş gibi verilerle tahmin etmek regresyana örnektir
# sonuç değişkeni sürekli mi kategorik mi: classification or regression
...
snf.predict(X_test)
snf.score(X_test,y_test) # bu score metodu hem predict yapıyo hem de mean
