...
# heralde columnların bir kısmını silersek olur
...
# demekki 105 tane öznitelikten modelde sadece 4'ü kullanılmış
...
# bu modelin performansı ridge ile kurulan modelden daha iyi çıktı
# modelde 105 öznitelikten yalnız 33'ü kullanıldı
# bu modelin daha iyi anlaşılmasını sağlar
# alpha'yı biraz daha azaltabiliriz ama bu sefer de regülerleştirmenin etkisi azaloır
# böylece lineer regresyona yaklaşır
lasso00001 = Lasso(alpha=0.00001,max_iter=100000).fit(X_egitim,y_egitim)
print(lasso00001.score(X_egitim,y_egitim))
print(lasso00001.score(X_test,y_test))
# pratikte bu iki modelden öncelikle ridge regresyonu tercih edilir
# fakat özniteik sayısı fazla ve bunlardan bazılarının daha önemli olduğu düşünülüyorsa lasso daha iyi bir tercihtir
### ELASTICNET
# ridge ve lasso'nun birleişmi
# lasso gibi katsayılardan bazılarını sıfır yaparken ridge'in regülerleştirme özelliğini koruyor
# pratikte bu birleşimin daha iyi çalıştığunı söyleyebiliriz
# elsaticnet katsayıların bağlantılı olduğu durumlarda da kullanılabilir
# lineer regresyonda sonuç değişkeni sürekli sayısal değişkendi. sonuç değişkeni kategorik ise 
# analiz için lojistik regresyon kullanılabilir